...
async fn web_client_routine(
    ...
    loop {
        ...
        controller.backend.mark_dashboard_connected();
...
impl WebClientSession {
    ...
    fn heartbeat_routine(
        ...
        let supports_remote_config = controller.backend.supports_remote_config();
        ...
        tasks.spawn(async move {
            loop {
                ...
                let request = HeartbeatRequest {
                    ...
                    support_config_source: supports_remote_config,
